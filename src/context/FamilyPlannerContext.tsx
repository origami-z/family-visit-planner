...
import { PlannerState, FamilyMember, Trip, GlobalSettings } from '@/types/planner';
...
const FamilyPlannerContext = createContext<FamilyPlannerContextType | null>(null);
...
export function useFamilyPlanner() {
  ...
  if (!context) {
    throw new Error('useFamilyPlanner must be used within FamilyPlannerProvider');
  }
  return context;
}