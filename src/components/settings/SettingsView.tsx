...
import { IconDownload, IconUpload, IconShare } from '@tabler/icons-react';
...
export function SettingsView() {
  ...
  const handleExportCSV = () => {
    ...
    state.trips.forEach(trip => {
      ...
      if (member) {
        csvRows.push(`${member.name},${trip.entryDate},${trip.departureDate},"${trip.notes || ''}"`);
      }
    });
  ...
  const handleImportCSV = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      ...
      alert('CSV import is currently limited. Please use JSON import for full data.');
    };
    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Import, export, and share your planning data</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Button onClick={handleShareURL} variant="outline" className="w-full">
          ...
          <div className="pt-4 border-t">
            <p className="text-sm text-muted-foreground">
              <strong>Note:</strong> Importing data will replace your current data. Make sure to export a backup first.
            </p>
          </div>
        </CardContent>
      </Card>
